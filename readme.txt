...
3. 메인 카테고리 : P-공통, G-게임, M-회원, A-관리자, N-공지사항, R-랭크 E-기타
  - '메인 카테고리'란 홈페이지 전체를 7가지로 세분화 하여 기능상으로 묶은 개념
  - 기능상으로 묶었기 때문에 사이트 맵과 다를 수 있음

4. 업무 분담
  - [김정호] - 모든 조에 들어가며 방향 제시 및 코딩, 디자인 관여, 회원, [게임]창던지기、채팅(미정)
  - 1조[유지상] - 메인, 상점, [게임]카드뒤집기(미정)
  - 2조[최원준] - 공지사항
  - 3조[박찬영, 유지상] - 랭킹
  - 4조[장세진, 천세문] - [게임]제목미정
